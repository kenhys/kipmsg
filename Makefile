...
ACLOCAL = ${SHELL} /pub/src/ipmsg/kipmsg.kde3/admin/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /pub/src/ipmsg/kipmsg.kde3/admin/missing --run tar
AR = ar
ARTSCCONFIG = 
AUTOCONF = $(SHELL) $(top_srcdir)/admin/cvs.sh configure || touch configure
AUTODIRS = 
AUTOHEADER = ${SHELL} /pub/src/ipmsg/kipmsg.kde3/admin/missing --run autoheader
AUTOMAKE = ${SHELL} /pub/src/ipmsg/kipmsg.kde3/admin/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /pub/src/ipmsg/kipmsg.kde3/admin/missing --run makeinfo
MAKEKDEWIDGETS = 
MCOPIDL = 
...
ac_ct_CXX = g++
ac_ct_F77 = gfortran
all_includes = -I/usr/include/kde -I/usr/lib/qt3/include -I. 
all_libraries = -L/usr/lib/qt3/lib -L/usr/lib   
am__fastdepCC_FALSE = #
am__fastdepCC_TRUE = 
...
install_sh = /pub/src/ipmsg/kipmsg.kde3/admin/install-sh
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/admin $(distdir)/debian $(distdir)/spec
...
#>+ 2
KDE_DIST=configure.files kipmsg.kdevelop.pcs aclocal.m4 Project.kdevses Doxyfile kipmsg.kdevelop Project.kdevelop.pcs Project.kdevelop stamp-h.in subdirs Makefile.in config.h.in configure.in kipmsg.kdevses Makefile.cvs sol10_blastwave_configure.sh libtool_freebsd61.patch acinclude.m4 Makefile.am configure Project.kdevelop.filelist 
