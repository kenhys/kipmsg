...
ACLOCAL = ${SHELL} /pub/src/ipmsg/kipmsg/admin/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /pub/src/ipmsg/kipmsg/admin/missing --run automake-1.9
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /pub/src/ipmsg/kipmsg/admin/missing --run makeinfo
MAKEKDEWIDGETS = 
