...
ACLOCAL = ${SHELL} /pub/src/ipmsg/kipmsg/admin/missing --run aclocal-1.8
AMDEP_FALSE = #
AMDEP_TRUE = 
...
AUTOMAKE = ${SHELL} /pub/src/ipmsg/kipmsg/admin/missing --run automake-1.8
AWK = gawk
CC = gcc
...
all_libraries = -L/usr/lib -L/usr/lib/qt3/lib -L/usr/X11R6/lib   
am__fastdepCC_FALSE = #
am__fastdepCC_TRUE = 
...
#>+ 2
KDE_DIST=kipmsg.kdevelop.pcs configure.files aclocal.m4 Project.kdevses Doxyfile kipmsg.kdevelop Project.kdevelop.pcs Project.kdevelop stamp-h.in subdirs Makefile.in config.h.in configure.in Makefile.cvs kipmsg.kdevses sol10_blastwave_configure.sh libtool_freebsd61.patch configure acinclude.m4 Makefile.am Project.kdevelop.filelist 
