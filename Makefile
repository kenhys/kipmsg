...
#>+ 2
KDE_DIST=kipmsg.kdevelop.pcs configure.files Project.kdevses Doxyfile kipmsg.kdevelop Project.kdevelop.pcs Project.kdevelop stamp-h.in subdirs Makefile.cvs kipmsg.kdevses sol10_blastwave_configure.sh libtool_freebsd61.patch Project.kdevelop.filelist 
