...
#include <qtimer.h>
#include "downloadmonitorbase.h"

class KIpMsgDownloadMonitor : public KIpMsgDownloadMonitorBase
{
    Q_OBJECT

public:
    KIpMsgDownloadMonitor(QWidget* parent = 0, const char* name = 0, WFlags fl = 0 );
